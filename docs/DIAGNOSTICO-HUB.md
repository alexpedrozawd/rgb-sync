...
| 2026-09-05 | **Calibração Visual Fina do Water Cooler.** | Water Cooler afinado para `COOLER_COLOR=243330` (branco sutil esverdeado com brilho aumentado a pedido do dono). Hub mantido em `707090` (48% duty) e RAMs em `7272C0`. |
